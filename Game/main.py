...
#     def __init__(self, striker_color, striker_speed, striker_collide, player_turn):
#         self.striker_color = striker_color
#         self.striker_speed = striker_speed
#         self.striker_collide = striker_collide
#         self.player_turn = player_turn

    
#     striker_piece = pygame.draw.circle(screen, WHITE, center, 2)
...
#         if striker_piece.collidepoint((sx,sy)):
